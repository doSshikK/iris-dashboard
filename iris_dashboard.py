...
# ------------- Страница: Кластеризация -------------
    ...
    st.info("По графику видно, что оптимальное количество кластеров является k=3,
    так как дальнейшее увеличение количества кластеров не приводит к значительному уменьшению инерции")
